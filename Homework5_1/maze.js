...
function start() {
    ...
    document.getElementById("road_1").addEventListener("mouseover", function() {
        path[0] = 1
    });
    document.getElementById("road_2").addEventListener("mouseover", function() {
        path[1] = 1
    });
    document.getElementById("road_3").addEventListener("mouseover", function() {
        path[2] = 1
    });
}
